...
{
    [DBTable("lpriv_tip", "bd_isp", OldDBName = "bd_isp", OldTableName = "lpriv_tip")]
    public class LengthBringingType : BaseEntity
    {
        ...
        public const string BringingId_ColumnName = "LprivInd";
        public const string BringingMeasure_ColumnName = "Ed_izm";
        public const string BringingName_ColumnName = "LprivName";
        #endregion
