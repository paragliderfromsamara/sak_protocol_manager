...
{
    [DBTable("tipy_baraban", "bd_isp", OldDBName = "bd_isp", OldTableName = "tipy_baraban")]
    public class BarabanType : BaseEntity
    {
        ...
        public const string TypeId_ColumnName = "TipInd";
        public const string TypeName_ColumnName = "TipName";
        public const string BarabanWeight_ColumnName = "Massa";
        #endregion
    }
}
