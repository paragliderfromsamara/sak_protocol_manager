...
{
    [DBTable("barabany", "bd_isp", OldDBName = "bd_isp", OldTableName = "barabany")]
    public class ReleasedBaraban : BaseEntity
    {
        ...
        public const string BarabanId_ColumnName = "BarabanInd";
        public const string BarabanSerialNumber_ColumnName = "BarabanNum";
        #endregion
    }
}
