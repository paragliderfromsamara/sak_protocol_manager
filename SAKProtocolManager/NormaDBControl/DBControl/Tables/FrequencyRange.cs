...
{
    [DBTable("freq_diap", "bd_isp", OldDBName = "bd_isp", OldTableName = "freq_diap")]
    public class FrequencyRange : BaseEntity
    {
        ...
        public const string FreqRangeId_ColumnName = "FreqDiapInd";
        public const string FreqMin_ColumnName = "FreqMin";
        public const string FreqMax_ColumnName = "FreqMax";
        public const string FreqStep_ColumnName = "FreqStep";
