...
{
    [DBTable("tipy_poviv", "bd_isp", OldDBName = "bd_cable", OldTableName = "tipy_poviv")]
    public class CableStructureType : BaseEntity
    {
        ...
        public const string TypeId_ColumnName = "StruktNum";
        public const string TypeName_ColumnName = "StruktTip";
        public const string LeadAmount_ColumnName = "ColvoGil";
        public const string MeasuredParametersList_ColumnName = "Set_ParamInd";
        #endregion
