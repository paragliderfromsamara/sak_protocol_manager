...
{
    [DBTable("status_isp", "bd_isp", OldDBName = "bd_isp", OldTableName = "status_isp")]
    public class CableTestStatus : BaseEntity
    {
        ...
        public const string StatusId_ColumnName = "Status";
        public const string StatusText_ColumnName = "StatusName";
        #endregion
