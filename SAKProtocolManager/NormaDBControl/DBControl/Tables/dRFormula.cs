...
{
    [DBTable("dr_formuls", "bd_isp", OldDBName = "bd_cable", OldTableName = "dr_formuls")]
    public class dRFormula : BaseEntity
    {
        ...
        public const string FormulaId_ColumnName = "DRInd";
        public const string FormulaName_ColumnName = "DRName";
        public const string FormulaMeasure_ColumnName = "ResEd";
        public const string FormulaDescription_ColumnName = "DROpis";
        #endregion
