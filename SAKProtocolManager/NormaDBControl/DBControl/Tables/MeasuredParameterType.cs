...
{
    [DBTable("ism_param", "bd_isp", OldDBName = "bd_cable", OldTableName = "ism_param")]
    public class  MeasuredParameterType : BaseEntity
    {
        ...
        public const string ParameterTypeId_ColumnName = "ParamInd";
        public const string ParameterName_ColumnName = "ParamName";
        public const string ParameterMeasure_ColumnName = "Ed_izm";
        public const string ParameterDescription_ColumnName = "ParamOpis";
        #endregion
    }
