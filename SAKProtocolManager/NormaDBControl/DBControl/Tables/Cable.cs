...
namespace NormaMeasure.DBControl.Tables
{
    ...
    public class Cable : BaseEntity
    {
        ...
        public const string CodeKCH_ColumnName = "KodOKP_KCH";
        public const string LinearMass_ColumnName = "PogMass";
        public const string BuildLength_ColumnName = "StrLengt";
        public const string UCover_ColumnName = "U_Obol";
    ...
    [DBTable("cables", "bd_isp", OldDBName = "bd_isp", OldTableName = "cables")]
