...
{
    [DBTable("norm_docum", "bd_isp", OldDBName = "bd_cable", OldTableName = "norm_docum")]
    public class Document : BaseEntity
    {
        ...
        public const string DocumentId_ColumnName = "DocInd";
        public const string ShortName_ColumnName = "DocNum";
        public const string FullName_ColumnName = "DocName";
